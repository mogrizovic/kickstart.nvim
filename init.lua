...
vim.api.nvim_create_user_command('Q', 'qal!', {})
...
require('lazy').setup({
  ...
  {
    'mbbill/undotree',
    vim.keymap.set('n', '<leader>ut', vim.cmd.UndotreeToggle, { desc = '[U]ndoo [T]ree' }),
  },
  ...
  vim.keymap.set('n', '<leader>tt', vim.cmd.Neotree, { desc = '[T]oggle Neo[T]ree' }),
